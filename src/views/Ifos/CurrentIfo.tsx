    ...
    <div>
      ...
      <LaunchIfoCallout>
        <div>
          ...
          <Flex mb="16px">
            <LinkExternal href="http://exchange.pharmswap.finance/#/swap" mr="16px">
              {TranslateString(999, 'Buy cake')}
            </LinkExternal>
            <LinkExternal href="http://exchange.pharmswap.finance/#/add/ETH/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82">
          ...
          <Text as="div" pt="16px">
            <Button
              as="a"
              variant="secondary"
              href="https://docs.pharmswap.finance/core-products/ifo-initial-farm-offering"
            >
